...
Public Class ventasForm
    ...
    Private Sub ventasForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SendMessage(Me.txtBuscar.Handle, &H1501, 0, "Escriba el nombre del producto aquí") 'Hint Text
    ...
    Public Sub LlenaBoton()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            For Each fila In ds.Tables(0).Rows
                MiBoton = New Button()
                Dim myfont As New Font("Verdana", 15, FontStyle.Bold)
